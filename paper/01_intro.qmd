...
1. **RQ1.** Do Quantile Regression Forests (QRF) deliver lower pinball loss for 72‑hour returns than Linear Quantile Regression and LightGBM across τ ∈ {0.05, 0.10, 0.25, 0.50, 0.75, 0.90, 0.95}?
2. **RQ2.** After post‑hoc calibration, do QRF intervals achieve closer‑to‑nominal coverage (80%/90%) with competitive width?
3. **RQ3.** Which feature families (momentum, volatility, liquidity, on‑chain activity, cross‑asset) drive tail behaviour in mid‑cap Solana tokens?
