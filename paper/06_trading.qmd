...
![Portfolio equity curves. Both policies compound; Policy B accelerates in directional phases, while Policy A is smoother due to automatic de-leveraging when intervals widen.](figures/results/fig-equity-curves.pdf){#fig-equity-portfolio fig-align="center" width="80%"}
...
![Per-token Sharpe (top 20, QRF). Blue = Policy A (risk-scaled). Orange = Policy B (thresholded).](figures/results/fig-token-sharpe-qrf.pdf){#fig-token-sharpe fig-align="center" width="95%"}
