...
![Per-token pinball loss by model and quantile τ. Boxes summarise dispersion across tokens; black diamonds mark the cross-token mean for each model–τ; faint points show individual token means.](figures/raw/fig-pinball-by-token.pdf){#fig-pinball-by-token fig-align="center" width="82%"}
